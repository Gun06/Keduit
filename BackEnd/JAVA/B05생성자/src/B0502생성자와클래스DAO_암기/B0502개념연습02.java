...
//	}
	...
	Patient(){}
	Patient(int number, String name, String birth, String phone1, String phone2, String phone3 , String location){
		this.number = number;
		this.name = name;
		this.birth = birth;
		this.phone1 = phone1;
...
class PatientDAO{
	...
	void setData(String[][] arr) {
	    ...
	    for(int i = 0; i < patientList.length; i++) {
	    		...
	    		Patient pa = new Patient(number, arr[i][1],  arr[i][2],  arr[i][3],  arr[i][4],  arr[i][5],  arr[i][6]);
