...
/*
	[문제]
		환자 정보를 지역번호 순으로 내림차순 정렬한 후, 출력하시오.
		단, 지역번호가 같으면 번호 순으로 오름차순 정렬하시오.
	[출력예시]
...
public class B0204개념연습08 {
	public static void main(String[] args) {
	    ...
	    Arrays.sort(patientList, (a , b)->{
			if(a.location.compareTo(b.location) < 0) {
				return 1;
			}else if(a.location.compareTo(b.location) > 0) {
				return -1;
			}else {
