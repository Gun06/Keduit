...
class StudentDAO{
	/*
	  	모든 변수와 메서드에 static을 붙이는건 불편하기때문에
	  	내부에 변수에 new 를 하고 그변수에만 static을 붙여서 사용한다. 
	  	최종적으로는  StudentDAO.instance 의 모양이된다. 
	 */
	static StudentDAO instance = new StudentDAO();
...
public class B0703개념01스태틱전체화학생수정 {
	public static void main(String[] args) {
		...
		StudentDAO.instance.getSolution();
		System.out.println("----------");
		StudentDAO.instance.printList();
	}
}
